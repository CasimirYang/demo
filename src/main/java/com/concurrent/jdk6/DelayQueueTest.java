...
public class DelayQueueTest {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        DelayedDemo delayedDemo = new DelayedDemo(10000,1); //deplay 设置的不是expire 时间， 设置的是延迟多久才可以执行的时间
        delayQueue.put(delayedDemo);
        DelayedDemo delayedDemo2 = new DelayedDemo(15000,2); //deplay 设置的不是expire 时间， 设置的是延迟多久才可以执行的时间
        delayQueue.put(delayedDemo2);
        DelayedDemo delayedDemo3 = new DelayedDemo(5000,3); //deplay 设置的不是expire 时间， 设置的是延迟多久才可以执行的时间
        delayQueue.put(delayedDemo3);
        DelayedDemo delayedDemo4 = new DelayedDemo(7000,4); //deplay 设置的不是expire 时间， 设置的是延迟多久才可以执行的时间
        delayQueue.put(delayedDemo4);
        DelayedDemo delayedDemo5 = new DelayedDemo(6000,5); //deplay 设置的不是expire 时间， 设置的是延迟多久才可以执行的时间
